...
# import solution.objdet_pcl as pcl
...
EXE_L2 = 'lesson-2-object-detection/exercises/solution'
...
while True:
    try:
        ...
        # bev_map = l2_examples.render_obj_over_bev(detections, lidar_bev_labels, configs, False)
